...
/**
 * Renderiza o Menu Superior flutuante com design Glassmorphism 2026
 */
export const renderMenuSuperior = (containerId) => {
    ...
    const html = `
        ...
        <style>
            ...
            .user-role { font-size: 0.7rem; color: rgba(255, 255, 255, 0.4); text-transform: uppercase; letter-spacing: 0.5px; }
